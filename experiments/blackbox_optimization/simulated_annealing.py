...
def simulated_annealing_without_domain_knowledge(maxiter: int, no_local_search: bool) -> dict[str, float | int]:
    # Standard tuple of LEO params
    # - ['0', '1', '2', '3', '4']
    # - ['e', 'h', 'i', 'o', 'p']
    bounds = (
...
def simulated_annealing_with_domain_knowledge(maxiter: int, no_local_search: bool) -> dict[str, float | int]:
