...
'''
This script illustrates LEO dynamic and route changes between two ground stations over time.
Renders 3D view of frame by frame with 1 seconds of granularity.
'''
...
for t in range(0, 1500, 1):
    ...
    sat_info = leo_con.sat_info('S0-1')
    ...
    view = SatView3D(
        leo_con,
        # lat=sat_info.nadir_latitude,
        lat=16.80528,
        # long=sat_info.nadir_longitude,
        long=96.15611,
        title=f'Time: {t}s'
    )
    ...
    # view.add_ISLs((
    #     ('S0-0', 'S0-1'), ('S0-1', 'S0-2'),
    #     ('S0-12', 'S0-13'), ('S0-13', 'S0-14'),
    #     ('S0-0', 'S0-12'), ('S0-1', 'S0-13'), ('S0-2', 'S0-14')
    # ))
    ...
    # else:
    #     view.highlight_satellites(
    #         ['S0-0', 'S0-1', 'S0-2', 'S0-12', 'S0-13', 'S0-14'])
    ...
    # view.export_html()
    view.export_png(f'{OUTPUT_DIR}/{str(t).zfill(4)}.png')
