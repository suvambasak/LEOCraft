...
from ignore_project_path import *
...
# leo_con.set_time(minute=10)  # Time passed after epoch
leo_con.set_time()
...
# print(leo_con.shells[0].distance_between_sat_m(0, 12, leo_con.time_delta))
...
# view.highlight_satellites(['S0-0', 'S0-1', 'S0-2', 'S0-12', 'S0-13', 'S0-14'])
