...
'''
This example simulates a LEO constellation with proposed inter shell ISLs.
It uses the FSPL path loss model and computes the throughput, coverage, and 
latency/stretch performance metrics.
'''
